...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2025 a las 16:10:12
...
INSERT INTO `mapas` (`ID_mapa`, `nombre`, `imagen`) VALUES
(1, 'Purgatorio', 'imagen cool'),
(2, 'Bermuda', 'imagen br');
...
CREATE TABLE `salas` (
  ...
  `jugadores_actuales` int(10) UNSIGNED DEFAULT 0,
  `estado` enum('Abierta','Llena') NOT NULL DEFAULT 'Abierta',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `jugadores_maximos` int(11) NOT NULL DEFAULT 5
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `salas` (`ID_sala`, `ID_mapa`, `ID_tipo_juego`, `jugadores_actuales`, `estado`, `created_at`, `jugadores_maximos`) VALUES
(1, 2, 1, 0, 'Abierta', '2025-03-07 21:53:06', 5),
(2, 2, 1, 0, 'Abierta', '2025-03-07 21:53:06', 5),
(3, 2, 1, 0, 'Abierta', '2025-03-07 21:53:06', 5);
...
CREATE TABLE `tipo_juego` (
  `ID_tipo_juego` int(11) NOT NULL,
  `tipo_juego` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tipo_juego` (`ID_tipo_juego`, `tipo_juego`) VALUES
(1, 'BR-Clasific'),
(2, 'DE-Clasific');
...
--
ALTER TABLE `partida`
  MODIFY `ID_partida` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `partida`
  ADD CONSTRAINT `partida_ibfk_1` FOREIGN KEY (`ID_usuario`) REFERENCES `usuarios` (`ID_usuario`) ON DELETE CASCADE,
  ADD CONSTRAINT `partida_ibfk_2` FOREIGN KEY (`ID_sala`) REFERENCES `salas` (`ID_sala`) ON DELETE CASCADE;
...
ALTER TABLE `salas`
  ...
  ADD CONSTRAINT `salas_ibfk_2` FOREIGN KEY (`ID_tipo_juego`) REFERENCES `tipo_juego` (`ID_tipo_juego`) ON DELETE CASCADE;

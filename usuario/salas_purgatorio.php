...
$mapSelect = 2; // ID del mapa para Purgatorio

// Obtener salas del mapa seleccionado
$sqlSalas = $con->prepare("SELECT * FROM salas WHERE ID_mapa = :id_mapa ORDER BY created_at ASC");
...
<head>
    ...
    <title>Salas Disponibles - Mundo Purgatorio</title>
...
.btn-disabled {
    ...
    <main class="container">
        <h2>Salas disponibles - Mundo Purgatorio</h2>
